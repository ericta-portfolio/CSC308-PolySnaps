def compareProfiles(p1, p2):
  ...
  moreHobby = p1['hobbies'] if (len(p1['hobbies']) > len(p2['hobbies'])) else p2['hobbies']
  lessHobby = p1['hobbies'] if (len(p1['hobbies']) <= len(p2['hobbies'])) else p2['hobbies']
  ...
  moreParty = p1['partying'] if (len(p1['partying']) > len(p2['partying'])) else p2['partying']
  lessParty = p1['partying'] if (len(p1['partying']) <= len(p2['partying'])) else p2['partying']
