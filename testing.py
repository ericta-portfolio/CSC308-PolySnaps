...
class TestStringMethods(unittest.TestCase):
    ...
    def test3_reject_user1(self):
        tester = app.test_client(self)
        id = pytest.user_id
        response = tester.post('/rejectMatch/' + id, json={"match":"123456789012345678901234"}, content_type='application/json', follow_redirects=True)
        self.assertEqual(response.status_code,201)
        
    def test3_reject_user2(self):
        tester = app.test_client(self)
        id = pytest.user_id
        response = tester.post('/rejectMatch/' + id, json={"match":"123456789012345678901235"}, content_type='application/json', follow_redirects=True)
        self.assertEqual(response.status_code,201)

    def test3_reject_user_fail(self):
        tester = app.test_client(self)
        id = pytest.user_id
        response = tester.post('/rejectMatch/' + id, json={"match":"0"}, content_type='application/json', follow_redirects=True)
        self.assertEqual(response.status_code,400)
        
    def test3_accept_user1(self):
        tester = app.test_client(self)
        id = pytest.user_id
        response = tester.post('/acceptMatch/' + id, json={"match":"123456789012345678901234"}, content_type='application/json', follow_redirects=True)
        self.assertEqual(response.status_code,201)
        
    def test3_accept_user2(self):
        tester = app.test_client(self)
        id = pytest.user_id
        response = tester.post('/acceptMatch/' + id, json={"match":"123456789012345678901235"}, content_type='application/json', follow_redirects=True)
        self.assertEqual(response.status_code,201)

    def test3_accept_user_fail(self):
        tester = app.test_client(self)
        id = pytest.user_id
        response = tester.post('/acceptMatch/' + id, json={"match":"0"}, content_type='application/json', follow_redirects=True)
        self.assertEqual(response.status_code,400)
